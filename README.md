...
\
Нельзя удалить категорию/продавца/счёт, если они используются в транзакции (при редактировании ⚠️ значок на месте кнопки удаления)\
\
...
1. Помещал файлы проекта в папку с серверами (domanis)
